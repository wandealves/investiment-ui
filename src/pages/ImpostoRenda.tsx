...
} from "@/features/impostoderenda/hooks/useImpostoRenda";
        ...
        {calculoAtual && (
          <div className="space-y-6">
            <div className="text-sm text-muted-foreground">
              Último cálculo:{" "}
              {new Date(calculoAtual.data).toLocaleString("pt-BR")}
            </div>
              ...
              <CardContainer className="inter-var">
                <CardBody className="group relative rounded-lg border bg-card p-6 shadow-sm transition-all duration-300 overflow-hidden hover:shadow-2xl hover:shadow-primary/20 hover:border-primary/50">
                  <div
                    ...
                    style={{
                      background:
                        "linear-gradient(120deg, transparent 0%, hsl(var(--primary) / 0.05) 50%, transparent 100%)",
                  ...
                  <div className="relative flex items-center justify-between">
                    <div className="flex-1">
                      ...
                      >
                        {formatCurrency(calculoAtual.total)}
                      </CardItem>
                    </div>
                    <CardItem
                      translateZ="80"
                ...
                <table className="w-full border-collapse">
                  ...
                  <tbody>
                    {calculoAtual.itens.map(item => (
                      <tr
                        key={item.ativoId}
                        className="border-b last:border-0 hover:bg-muted/30 transition-colors duration-200"
                      >
                        <td className="p-4">
                          <div>
                        ...
                        <td className="p-4 text-right font-mono text-sm">
                          ...
                          item.rendimento !== undefined ? (
                            <span
                              className={
                                Number(item.rendimento) >= 0
                        ...
                        <td className="p-4 text-right font-mono text-sm">
                          {formatCurrency(item.taxasRateadas)}
                        </td>
                      </tr>
                    ))}
                  </tbody>
